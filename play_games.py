...
def play(game, players, num_searches, add_noise, print_games):
    turn_count = 0
    if print_games:
        game.print_board()
    ...
    while True:
        ...
        current_player_node = player.play_move(game, player_num, turn_count, current_player_node, num_searches, add_noise, print_games)
...
def play_games(game, num_games, players, num_searches):
    ...
    for game_num in range(num_games):
        ...
        result_num, _, _ = play(new_game, players, num_searches, False, True)
